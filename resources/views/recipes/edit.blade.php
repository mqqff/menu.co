        ...
        <form method="POST" action="{{ route('recipes.update', $recipe->id) }}" enctype="multipart/form-data" id="editForm">
            ...
            <div class="flex flex-col items-center lg:flex-row lg:items-start gap-8">
                ...
                <div class="w-full max-w-xl lg:flex-1 lg:max-w-none">
                    <input type="text" id="recipeTitle" name="title" placeholder="Title" value="{{ $recipe->title }}" autofocus required
                    ...
                    <div class="flex flex-wrap gap-3 mb-3.5">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <input type="number" id="budgetMin" name="budget_min" placeholder="5000" step="0.01" value="{{ $recipe->budget_min }}"
                                   class="w-16 sm:w-20 bg-gray-100 border-none rounded-lg px-3 py-2 text-sm text-gray-600 outline-none transition-shadow focus:shadow-[0_0_0_2px_#f4b89a] placeholder:text-gray-400">
                            <span class="text-gray-400 text-sm">-</span>
                            <input type="number" id="budgetMax" name="budget_max" placeholder="7000" step="0.01" value="{{ $recipe->budget_max }}"
                                   class="w-16 sm:w-20 bg-gray-100 border-none rounded-lg px-3 py-2 text-sm text-gray-600 outline-none transition-shadow focus:shadow-[0_0_0_2px_#f4b89a] placeholder:text-gray-400">
                            <span class="text-gray-500 text-xs">Rp</span>
                        </div>
                    </div>
                    ...
                    <textarea id="description" rows="2" placeholder="Share a little more about this dish." name="description"
                              class="w-full bg-gray-100 border-none rounded-xl px-4 py-3 text-sm text-gray-600 outline-none resize-none transition-shadow focus:shadow-[0_0_0_2px_#f4b89a] mb-5 placeholder:text-gray-400">{{ $recipe->description }}</textarea>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="tips" rows="3" placeholder="Share your tips to recreate the dish here." name="tips"
                                  class="w-full bg-gray-100 border-none rounded-xl px-4 py-3 text-sm text-gray-600 outline-none resize-none transition-shadow focus:shadow-[0_0_0_2px_#f4b89a] placeholder:text-gray-400">{{ $recipe->tips }}</textarea>
                    </div>
    ...
    <script>
        ...
        function loadRecipe() {
            steps = recipe.steps.map(s => ({
                id: stepCounter++,
                title: s.text,
                previewUrl: s.image ? `${s.image_url}` : null
            }));

            ingredients = recipe.ingredient_groups.flatMap(g => [
                { id: ingredientCounter++, name: g.label, isSection: true },
